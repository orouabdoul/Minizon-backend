...
class AdminReservationController extends Controller
{
    ...
    private function format(Booking $booking): array
    {
        ...
        return [
            ...
            // ── Points passager — commune → arrondissement → quartier ──
                                ...
                                new OA\Property(
                                    ...
                                    items: new OA\Items(
                                        properties: [
                                            ...
                                            // ── Points passager ──
                                            new OA\Property(property: 'pickup_city',           type: 'string',  nullable: true, example: 'Cotonou'),
                                            ...
                                            new OA\Property(property: 'pickup_address',        type: 'string',  nullable: true, example: 'Face pharmacie'),
                                            new OA\Property(property: 'dropoff_city',          type: 'string',  nullable: true, example: 'Parakou'),
