...
class PassengerTripDetailController extends Controller
{
    ...
    #[OA\Schema(
        ...
        properties: [
            ...
            new OA\Property(property: 'departure_note',           type: 'string', example: 'Carrefour Vêdoko', description: 'Quartier ou point précis de départ'),
            new OA\Property(property: 'arrival_arrondissement',   type: 'string', nullable: true, example: 'Godomey'),
            new OA\Property(property: 'arrival_note',             type: 'string', example: 'Université d\'Abomey-Calavi', description: 'Quartier ou point précis d\'arrivée'),
